...
class LogConfigHub {
  ...
  void setTagLevel(String tag, LogLevel level) =>
      update((LogConfig c) => c.copyWith(tagLevels: <String, LogLevel>{...c.tagLevels, tag: level}));
...
class RateConfig {
  ...
  static RateConfig defaults() => RateConfig(
        enabled: true,
        global: TokenBucket(capacity: 200, refillPerSec: 200),
      );
}
