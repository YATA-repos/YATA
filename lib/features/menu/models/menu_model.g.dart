...
MenuItemOption _$MenuItemOptionFromJson(Map<String, dynamic> json) => MenuItemOption(
  menuItemId: json['menuItemId'] as String,
  optionName: json['optionName'] as String,
  optionValues: (json['optionValues'] as List<dynamic>).map((e) => e as String).toList(),
...
Map<String, dynamic> _$MenuItemOptionToJson(MenuItemOption instance) => <String, dynamic>{
  'id': instance.id,
  'userId': instance.userId,
