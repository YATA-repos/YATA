...
class StockAdjustmentRepository
    extends BaseRepository<StockAdjustment, String> {
  /// コンストラクタ
  StockAdjustmentRepository() : super(tableName: "stock_adjustments");

  @override
  StockAdjustment Function(Map<String, dynamic> json) get fromJson =>
      StockAdjustment.fromJson;

  /// 材料IDで調整履歴を取得
  Future<List<StockAdjustment>> findByMaterialId(
    String materialId,
    String userId,
  ) async {
